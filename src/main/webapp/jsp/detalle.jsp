...
<html>
<head>
    <meta charset="UTF-8"><script>(function(){try{document.documentElement.setAttribute('data-theme', localStorage.getItem('qd-tema')||'light');}catch(e){}})();</script><title>${elemento.nombre} · Quito Descubre</title>
                ...
                <div class="container" style="padding:0;max-width:none;">
                    ...
                    <div class="detalle-header">
                        <c:if test="${not empty elemento.urlImagen}">
                            <img src="${elemento.urlImagen}" alt="${elemento.nombre}"
                                 class="detalle-header-img"
                                 onerror="this.remove();" />
                        </c:if>
                        <span class="tag-tipo">
                            <c:choose>
